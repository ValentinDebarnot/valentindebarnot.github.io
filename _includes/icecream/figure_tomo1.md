  ...
  <div class="viewer">
    <div class="img-column">
      ...
      <div class="img-wrapper">
        <img id="imgEq1" src="../images/icecream/png/tomo1_eq/slice_00035.jpg">
      </div>
    </div>
    <div class="img-column">
      <div class="img-title">DeepDeWedge</div>
      <div class="img-wrapper">
        <img id="imgDdw1" src="../images/icecream/png/tomo1_ddw/slice_00035.jpg">
      </div>
    </div>
  </div>

  <div id="controls">
    <input type="range" id="sliceSlider" min="0" max="77" step="1" value="35">
    <span id="sliceValue">Slice number: 35</span>
  </div>
  <div id="zoomButtons1">
  ...
  <script>
    (function() {
      ...
      function updateImages() {
        const index = parseInt(sliceSlider.value, 10);
        const padded = String(index).padStart(5, '0');
        sliceValue.textContent = `Slice: ${index}`;
        imgEq.src = `../images/icecream/png/tomo1_eq/slice_${padded}.jpg`;
        imgDdw.src = `../images/icecream/png/tomo1_ddw/slice_${padded}.jpg`;
      }
      ...
      // Slice slider event
      sliceSlider.addEventListener('input', updateImages);
...
<!-- ====================== FIGURE 2 ====================== -->
<div id="custom-figure-2">
  <style>
    #custom-figure-2 .viewer {
      display: flex;
      justify-content: center;
      align-items: center;
      gap: 20px;
    }
    #custom-figure-2 .img-wrapper {
      position: relative;
      overflow: hidden;
  ...
  <div class="viewer">
    <div class="img-column">
      <div class="img-title">🍦 ICECREAM</div>
      <div class="img-wrapper">
        <img id="imgEq2" src="../images/icecream/png/tomo1_eq/FT.png">
      </div>
    </div>
    <div class="img-column">
      <div class="img-title">DeepDeWedge</div>
      <div class="img-wrapper">
        <img id="imgDdw2" src="../images/icecream/png/tomo1_ddw/FT.png">
      </div>
    </div>
  </div>
  ...
  <script>
    (function() {
      const container = document.querySelector('#custom-figure-2');
