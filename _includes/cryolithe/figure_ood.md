  ...
  <div class="viewer">
    <div class="img-column">
      ...
      <div class="img-wrapper">
        <img id="img1" src="../images/cryolithe/png/figure_4/cryolithe/slice_00006.jpg">
      </div>
    </div>
    <div class="img-column">
      <div class="img-title">🍦 Icecream</div>
      <div class="img-wrapper">
        <img id="img2" src="../images/cryolithe/png/figure_4/icecream/slice_00006.jpg">
      </div>
    </div>
    <div class="img-column">
      <div class="img-title">FBP</div>
      <div class="img-wrapper">
        <img id="img3" src="../images/cryolithe/png/figure_4/fbp/slice_00006.jpg">
      </div>
    </div>
  </div>

  <div id="controls">
    <input type="range" id="sliceSlider0" min="0" max="13" step="1" value="6">
    <span id="sliceValue0">Slice: 6  </span>
  </div>
  ...
  <script>
    (function() {
      ...
      function updateImages() {
        ...
        imgs[0].src = `../images/cryolithe/png/figure_4/cryolithe/slice_${padded}.jpg`;
        imgs[1].src = `../images/cryolithe/png/figure_4/icecream/slice_${padded}.jpg`;
        imgs[2].src = `../images/cryolithe/png/figure_4/fbp/slice_${padded}.jpg`;
      }
...
<div id="custom-figure-02">
  ...
  <div class="viewer">
    <div class="img-column">
      <div class="img-title">❄️ CryoLithe</div>
      <div class="img-wrapper">
        <img id="img1_2" src="../images/cryolithe/png/figure_4/cryolithe/FT.png" alt="CryoLithe Tomo 1">
      </div>
    </div>
    <div class="img-column">
      <div class="img-title">🍦 Icecream</div>
      <div class="img-wrapper">
        <img id="img2_2" src="../images/cryolithe/png/figure_4/icecream/FT.png" alt="ICECREAM Tomo 1">
      </div>
    </div>
    <div class="img-column">
      <div class="img-title"> FBP</div>
      <div class="img-wrapper">
        <img id="img3_2" src="../images/cryolithe/png/figure_4/fbp/FT.png" alt="FBP Tomo 2">
      </div>
    </div>
  </div>
